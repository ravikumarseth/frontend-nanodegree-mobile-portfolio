...
function updatePositions() {
    ...
    var phases = [];
    for (var j = 0; j < 5; j++) {
        phases[j] = Math.sin((scrollTopPosition / 1250) + j);
    }
...
// Detects Window Size. Taken from http://stackoverflow.com/a/8876069/6032818
...
document.addEventListener('DOMContentLoaded', function() {
    var cols = 8;
    var s = 256;
    var numberOfPizzas = (windowHeight / s) * cols + cols / 2;
    var basicLeft = [];
